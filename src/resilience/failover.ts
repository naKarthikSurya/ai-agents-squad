...
import { ContextCompactor, MessageFrame } from '../sdk/compaction.js';
...
export class FailoverCoordinator {
  ...
  public async executeTurn(
    ...
    primaryModelCall: () => Promise<string>,
    secondaryModelCall: (compactedHistory: MessageFrame[]) => Promise<string>
  ): Promise<string> {
    ...
    try {
      ...
      if (
        errorMsg.includes('Agent terminated due to error') ||
