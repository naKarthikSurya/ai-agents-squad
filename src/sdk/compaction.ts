...
export class ContextCompactor {
   ...
   */
  public estimateTokens(history: MessageFrame[]): number {
    let totalLength = 0;
   ...
   */
  public async processLifecycleHook(history: MessageFrame[]): Promise<MessageFrame[]> {
   ...
   */
  public compact(history: MessageFrame[]): MessageFrame[] {
    if (history.length <= 4) {
    ...
    const compactedHistory: MessageFrame[] = [];
